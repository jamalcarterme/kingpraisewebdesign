...
(function () {
      ...
      <div class="mx-auto max-w-7xl px-5 lg:px-8">
        <div class="mt-3 glass rounded-2xl flex items-center justify-between px-5 py-3">
          <a href="${root}index.html" class="flex items-center gap-2 group">
            <span class="bracket-mark text-2xl"><span class="bkt">&lt;</span><span class="slash">K</span><span class="bkt">/&gt;</span></span>
          ...
          <button id="menu-btn" class="lg:hidden text-white p-2" aria-label="Menu">
  ...
  window.KPWD_UI = { mountChrome, initReveal, toast, rootPrefix };
